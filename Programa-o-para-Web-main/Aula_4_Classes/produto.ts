class produto{
    ...
    constructor(nome: string, preco: number, qtdEmEstoque: number){
        this.nome = nome;
        this.preco = preco;
    ...
    get getqtdEmEstoque(): number{
        return this.qtdEmEstoque;
    }

    set setqtdEmEstoque(qtdEmEstoque: number){
        this.qtdEmEstoque = qtdEmEstoque;
    }
    ...
    venderProduto(quantidade: number){
        if(quantidade){
