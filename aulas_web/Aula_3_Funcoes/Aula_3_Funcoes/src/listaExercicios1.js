...
function inverteString(nome) {
    var nome2 = nome.split(""); // o metodo split serve para transformar uma string em uma array de string
    var nome3 = nome2.reverse(); // após isso, o metodo reverse é usado para inverter a ordem dessa array, esse método só funciona em arrays
    var nome4 = nome3.join(""); // e finalmente, o método join é usado para juntar e transformar uma array de string em uma string
