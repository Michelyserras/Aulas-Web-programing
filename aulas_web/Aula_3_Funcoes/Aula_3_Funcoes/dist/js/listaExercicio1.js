...
function inverteString(nome) {
    let nome2 = nome.split(""); // o metodo split serve para transformar uma string em uma array de string
    let nome3 = nome2.reverse(); // após isso, o metodo reverse é usado para inverter a ordem dessa array, esse método só funciona em arrays
